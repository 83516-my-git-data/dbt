...
int main() 
{
    ...
    printf("Yearly salary of Employee 1: %.2lf\n", emp1.monthlySalary * 12);
    printf("Yearly salary of Employee 2: %.2lf\n", emp2.monthlySalary * 12);

    set_salary(&emp1, emp1.monthlySalary * 1.1);
    set_salary(&emp2, emp2.monthlySalary * 1.1);

    printf("\nYearly salary of Employee 1 after raise: %.2lf\n", emp1.monthlySalary * 12);
    printf("Yearly salary of Employee 2 after raise: %.2lf\n", emp2.monthlySalary * 12);
